...
class LockOnRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LockOnRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LockOnRequest
    let len;
    let data = new LockOnRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new LockOnRequest(null);
...
class LockOnResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LockOnResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LockOnResponse
    let len;
    let data = new LockOnResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'server_interface/LockOnResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LockOnResponse(null);
...
module.exports = {
  Request: LockOnRequest,
  Response: LockOnResponse,
  md5sum() { return '685ca96bd6cc7d98e3174f48c9825cf9'; },
  datatype() { return 'server_interface/LockOn'; }
};
