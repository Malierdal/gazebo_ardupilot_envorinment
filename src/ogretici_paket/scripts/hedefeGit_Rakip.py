...
class WaypointSender: 
    def __init__(self):
        rospy.init_node("goto_gps_node_rakip")

        # Hedef GPS konumu (örnek: ODTÜ Teknokent civarı)
        self.target_lat = -35.358000   # derece cinsinden
        self.target_lon = 149.163800   # derece cinsinden
        ...
        rospy.wait_for_service("/mavros_rakip/cmd/command_int")
        try:
            goto_service = rospy.ServiceProxy("/mavros_rakip/cmd/command_int", CommandInt)
